...
//file upload functionality
  ...
  dateRangeData(){
    if(this.startYear>this.endYear){
      ...
      alert("Pleasecheck the selected months.");
      this.flag = false;
    }
    else if(this.startYear==this.endYear && this.startValue==this.endValue){
  ...
  validateInput() {
    ...
    if (this.date_flag == false && this.consensus_flag == false && this.my_flag == false && this.ag_flag == false) {
      this.flag = true
    }
...
getDADefaultSelection(){
  ...
  // console.log("DDATA :: "+JSON.stringify(this.finalData));
   ...
   captureScreen()  
   {  
     var data = document.getElementById('pdfId');  
