...
var ModalPrivilegeComponent = /** @class */ (function () {
    function ModalPrivilegeComponent() {
    }
    ModalPrivilegeComponent.prototype.customUser = function () {
    ...
    ModalPrivilegeComponent.prototype.customPrev = function () {
    ...
    ModalPrivilegeComponent = __decorate([
        Component({
    ...
    return ModalPrivilegeComponent;
}());
export { ModalPrivilegeComponent };
//# sourceMappingURL=modal-privilege.component.js.map