...
export class SemanticReportsComponent implements OnInit {
  ...
  constructor(private toasterService: ToastrService, private semanticReportsService: SemanticReportsService, private router: Router,private user: AuthenticationService) {}
